...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if (availableToOthers && !writtenByYourself && citingYourSource) {
            return true;
        }
        if (writtenAsCourseWork && !writtenByYourself && citingYourSource) {
            return true;
        }

        if (!writtenByYourself && availableToOthers && implementationRequired && citingYourSource) {
            return true;
        }
